        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#0A2140;border-radius:0 0 16px 16px;padding:20px 32px;text-align:center;border:1px solid rgba(14,165,233,0.15);border-top:none;">
              ...
              <p style="margin:0;font-size:11px;color:#1E3A5F;">Arutech Consultancy Services LLP &nbsp;·&nbsp; arutechconsultancy.com</p>
            </td>
          </tr>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
            ...
            <td style="background:#ffffff;padding:32px;border:1px solid #e2e8f0;border-top:none;border-bottom:none;">
              ...
              <table cellpadding="0" cellspacing="0" style="margin:12px 0 24px;">
                <tr>
                  ...
                  <td>
                    <a href="https://arutechconsultancy.com" style="display:inline-block;padding:10px 20px;background:#f1f5f9;color:#334155;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;border:1px solid #e2e8f0;">Visit Website →</a>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background:#f1f5f9;border-radius:0 0 16px 16px;padding:18px 32px;text-align:center;border:1px solid #e2e8f0;border-top:none;">
              <p style="margin:0;font-size:11px;color:#94A3B8;">Arutech Consultancy Services LLP &nbsp;·&nbsp; arutechconsultancy.com</p>
            </td>
          </tr>
